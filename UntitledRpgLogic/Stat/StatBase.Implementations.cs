...
public abstract partial class StatBase
{
    ...
    public static explicit operator int(StatBase stat) => stat.Value;
    ...
    {
        if (stat.MinValue == UntitledRpgLogic.Stat.StatBase.STAT_DEFAULT_MIN_VALUE)
        {
            return
    ...
    /// </summary>
    public static bool operator !=(StatBase left, StatBase right) => !(left == right);
