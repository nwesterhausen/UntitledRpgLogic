...
namespace UntitledRpgLogic.Tests
{
    ...
    public class StatBaseTests
    {
        ...
        public void AddPoints_LogsStatChanged()
        {
            ...
            var stat = new TestStat("Test", 100, 10, 0, logger: loggerMock.Object);
        ...
        {
            var stat = new TestStat("Wisdom", 100, 50, 0);
            string str1 = stat.ToString();
            string str2 = (string)stat;
        ...
        {
            var stat = new TestStat("Charisma", 100, 42, 0);
            int value = (int)stat;
        ...
        {
            var stat1 = new TestStat("Endurance", 100, 10, 0);
            var stat2 = new TestStat("Endurance", 100, 20, 0);
            var stat3 = new TestStat("Endurance", 100, 10, 5);
            var stat4 = new TestStat("Endurance", 100, 10, 0, logger: null);
        ...
        {
            var stat1 = new TestStat("Luck", 100, 10, 0);
            var stat2 = new TestStat("Luck", 100, 20, 0);
        ...
        {
            TestStat? stat = null;
            var stat2 = new TestStat("Dexterity", 100, 10, 0);
        ...
        {
            var stat1 = new TestStat("A", 100, 10, 0);
            var stat2 = new TestStat("B", 100, 10, 0);
        ...
        {
            var stat = new TestStat("Spirit", 100, 10, 0);
