...
public interface IHasSkills
{
    ...
    void AddSKillPoints(Guid skillId, int points = 1);
    ...
    /// <param name="skillId"></param>
    /// <param name="points"></param>
    void RemoveSKillPoints(Guid skillId, int points = 1);
    ...
    /// <param name="skill"></param>
    /// <returns></returns>
    bool TryGetSkill(Guid skillId, out ISkill? skill);
}
