...
public interface IDamageCalculator
{
    ...
    int CalculateFinalDamage(int damageAmount, IEnumerable<IAppliesDamageMitigation> mitigations);
    ...
    int GetPointDamageFromOptions(DamageOptions damageOptions, IStat stat);
}
