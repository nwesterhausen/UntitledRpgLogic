...
/// </summary>
public class StatDamageEventArgs
{
    /// <summary>
    ...
    /// </summary>
    public int AmountMitigated => IncomingDamage - FinalDamage;

    /// <summary>
    ///     Gets the percentage of damage mitigated.
    /// </summary>
    public float AmountMitigatedPercentage => IncomingDamagePercentage - FinalDamagePercentage;
}
