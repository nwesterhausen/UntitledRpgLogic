        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InnateSkillDefinitionIds = table.Column<byte[]>(type: "bytea", nullable: false),
                    StartingItemDefinitionIds = table.Column<byte[]>(type: "bytea", nullable: false),
                    RespiratoryProfile = table.Column<string>(type: "jsonb", nullable: true),
                    StartingStats = table.Column<string>(type: "jsonb", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaselineAmbients = table.Column<string>(type: "jsonb", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsMultiplicative = table.Column<bool>(type: "boolean", nullable: false),
                    ScalesOnBaseValue = table.Column<bool>(type: "boolean", nullable: false),
                    MaxStacks = table.Column<int>(type: "integer", nullable: false),
                    Duration = table.Column<float>(type: "real", nullable: false),
                    LoseAllStacksOnExpiration = table.Column<bool>(type: "boolean", nullable: false),
                    Priority = table.Column<int>(type: "integer", nullable: false),
                    ModifierEffectId = table.Column<byte[]>(type: "bytea", nullable: true),
                    StackEffectId = table.Column<byte[]>(type: "bytea", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<byte[]>(type: "bytea", nullable: false),
                    Name = table.Column<string>(type: "text", nullable: false),
                    HasChangeableValue = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ElectricalProperties = table.Column<string>(type: "jsonb", nullable: true),
                    FantasticalProperties = table.Column<string>(type: "jsonb", nullable: true),
                    MechanicalProperties = table.Column<string>(type: "jsonb", nullable: true),
                    SmeltYields = table.Column<string>(type: "jsonb", nullable: true),
                    ThermalProperties = table.Column<string>(type: "jsonb", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<byte[]>(type: "bytea", nullable: false),
                    Name = table.Column<string>(type: "text", nullable: false),
                    DefinitionId = table.Column<byte[]>(type: "bytea", nullable: true),
                    ...
                    Position_MapId = table.Column<byte[]>(type: "bytea", nullable: true),
                    AffectedStats = table.Column<string>(type: "jsonb", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<byte[]>(type: "bytea", nullable: false),
                    MapId = table.Column<byte[]>(type: "bytea", nullable: false),
                    ChunkX = table.Column<int>(type: "integer", nullable: false),
                    ChunkY = table.Column<int>(type: "integer", nullable: false),
                    MaterialPalette = table.Column<byte[]>(type: "bytea", nullable: false),
                    CompressedTileBlob = table.Column<byte[]>(type: "bytea", nullable: false),
                    Version = table.Column<long>(type: "bigint", nullable: false),
                    AmbientOverrides = table.Column<string>(type: "jsonb", nullable: true),
                    AtmosphereOverride = table.Column<string>(type: "jsonb", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AffectsCaster = table.Column<bool>(type: "boolean", nullable: false),
                    AffectsAllies = table.Column<bool>(type: "boolean", nullable: false),
                    NumberOfTargets = table.Column<int>(type: "integer", nullable: false),
                    CastTime = table.Column<float>(type: "real", nullable: false),
                    SkillDisciplineId = table.Column<byte[]>(type: "bytea", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<byte[]>(type: "bytea", nullable: false),
                    SkillDefinitionId = table.Column<byte[]>(type: "bytea", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<byte[]>(type: "bytea", nullable: false),
                    StatDefinitionId = table.Column<byte[]>(type: "bytea", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StatId = table.Column<byte[]>(type: "bytea", nullable: false),
                    DependsOnId = table.Column<byte[]>(type: "bytea", nullable: false),
                    Ratio = table.Column<float>(type: "real", nullable: false),
                    StatDefinitionId = table.Column<byte[]>(type: "bytea", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MaterialDefinitionId = table.Column<byte[]>(type: "bytea", nullable: false),
                    Id = table.Column<int>(type: "integer", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_material_state_properties_material_definitions_MaterialDefi~",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<byte[]>(type: "bytea", nullable: false),
                    ModifierDefinitionId = table.Column<byte[]>(type: "bytea", nullable: false),
                    EntityId = table.Column<byte[]>(type: "bytea", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IgnoresArmor = table.Column<bool>(type: "boolean", nullable: true),
                    Delay = table.Column<TimeSpan>(type: "interval", nullable: true),
                    BaseHealAmount = table.Column<float>(type: "real", nullable: true),
                    CanOverheal = table.Column<bool>(type: "boolean", nullable: true),
                    SummonEntityTemplateId = table.Column<byte[]>(type: "bytea", nullable: true),
                    Quantity = table.Column<int>(type: "integer", nullable: true),
                    AffectedAmbients = table.Column<string>(type: "jsonb", nullable: true),
                    AffectedStats = table.Column<string>(type: "jsonb", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaseValue = table.Column<int>(type: "integer", nullable: false),
                    CreatorEntityId = table.Column<byte[]>(type: "bytea", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EntityId = table.Column<byte[]>(type: "bytea", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    AbilityId = table.Column<byte[]>(type: "bytea", nullable: false),
                    RequirementType = table.Column<int>(type: "integer", nullable: false),
                    RequiredEntityId = table.Column<byte[]>(type: "bytea", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    EntityId = table.Column<byte[]>(type: "bytea", nullable: false),
                    InstancedSkillId = table.Column<byte[]>(type: "bytea", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    EntityId = table.Column<byte[]>(type: "bytea", nullable: false),
                    InstancedStatId = table.Column<byte[]>(type: "bytea", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    AbilityId = table.Column<byte[]>(type: "bytea", nullable: false),
                    EffectId = table.Column<byte[]>(type: "bytea", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ItemDefinitionId = table.Column<byte[]>(type: "bytea", nullable: false),
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Slot = table.Column<byte>(type: "smallint", nullable: false),
                    MaterialId = table.Column<byte[]>(type: "bytea", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrimaryMaterialId = table.Column<byte[]>(type: "bytea", nullable: true),
                    CraftedById = table.Column<byte[]>(type: "bytea", nullable: true),
                    EntityInventoryId = table.Column<byte[]>(type: "bytea", nullable: true)
                },
                constraints: table =>
                {
