        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    modifier_effect_id = table.Column<byte[]>(type: "bytea", nullable: true),
                    stack_effect_id = table.Column<byte[]>(type: "bytea", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<byte[]>(type: "bytea", nullable: false),
                    skill_definition_id = table.Column<byte[]>(type: "bytea", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<byte[]>(type: "bytea", nullable: false),
                    stat_definition_id = table.Column<byte[]>(type: "bytea", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    entity_inventory_id = table.Column<byte[]>(type: "bytea", nullable: true)
                },
                constraints: table =>
                {
