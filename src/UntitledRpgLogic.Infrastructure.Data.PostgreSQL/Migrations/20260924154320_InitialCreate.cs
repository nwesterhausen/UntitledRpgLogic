        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ore_deposits = table.Column<string>(type: "jsonb", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_modification_base_effects_modifications_modification_effect",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_modification_stack_effects_modifications_stack_effects_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    position_elevation = table.Column<short>(type: "smallint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    name = table.Column<string>(type: "text", nullable: false),
                    description = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: false),
                    dimension_scale = table.Column<int>(type: "integer", nullable: false),
                    dimensions_shape = table.Column<int>(type: "integer", nullable: false),
                    width = table.Column<float>(type: "real", nullable: false),
                    height = table.Column<float>(type: "real", nullable: false),
                    length = table.Column<float>(type: "real", nullable: false),
                    item_definition_id = table.Column<byte[]>(type: "bytea", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_item_shapes", x => x.id);
                    table.ForeignKey(
                        name: "fk_item_shapes_item_definitions_item_definition_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ability_definition_id = table.Column<byte[]>(type: "bytea", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "shaped_components",
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    shape_id = table.Column<byte[]>(type: "bytea", nullable: false),
                    material_id = table.Column<byte[]>(type: "bytea", nullable: false),
                    weight = table.Column<float>(type: "real", nullable: false),
                    volume = table.Column<float>(type: "real", nullable: false),
                    volume_scale = table.Column<int>(type: "integer", nullable: false),
                    durability = table.Column<float>(type: "real", nullable: false),
                    max_durability = table.Column<float>(type: "real", nullable: false),
                    item_id = table.Column<byte[]>(type: "bytea", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_shaped_components", x => x.id);
                    table.ForeignKey(
                        name: "fk_shaped_components_items_item_id",
                        column: x => x.item_id,
            ...
            migrationBuilder.CreateIndex(
                name: "ix_item_shapes_item_definition_id",
                table: "item_shapes",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_shaped_components_item_id",
