...
public static class EventIdValues
{
	...
	/// <summary>
	///     Indicates an entity had points in a named levelable change (e.g. a skill)
	/// </summary>
	public const int LevelablePointsChanged = 5607;

	/// <summary>
	///     Indicates an entity had points in a levelable change (e.g. xp)
	/// </summary>
	public const int LevelablePointsChangedGeneric = 5608;

	/// <summary>
	///     Indicates an entity had a named levelable change levels (e.g. a skill)
	/// </summary>
	public const int LevelChanged = 5609;

	/// <summary>
	///     Indicates an entity had an unamed levelable change levels (e.g. their base level)
	/// </summary>
	public const int LevelChangedGeneric = 5610;

	/// <summary>
	///     A skill is being set to a specific value.
	/// </summary>
	public const int SkillValueSet = 5611;

	/// <summary>
	///     A skill is being decreased.
	/// </summary>
	public const int SkillValueDecrease = 5612;

	/// <summary>
	///     A skill is being increased.
	/// </summary>
	public const int SkillValueIncrease = 5613;

	/// <summary>
	///     A max-level skill was attempted to be increased.
	/// </summary>
	public const int AttemptedIncreaseSkillAtMaxLevel = 5614;

	/// Sub-category: State Machine Events (5700 - 57xx)
	/// <summary>
	///     The main menu state machine was initialized.
	/// </summary>
	public const int MainMenuStateMachineInitialized = 5700;

	/// <summary>
	///     The main menu state machine transitioned to a new state.
	/// </summary>
	public const int MainMenuStateMachineTransitioned = 5701;
}
