...
public enum FractureType
{
	...
	/// </summary>
	/// <remarks>
	///     Poor Edge Retention. A brittle material can be sharpened (if hard) but the edge will chip and flake away very
	///     easily under impact.
	/// </remarks>
	Brittle,
	...
	/// </summary>
	/// <remarks>
	///     Excellent Toughness. Doesn't hold a sharp edge as well as a hard material, but it will bend or deform instead of
	///     breaking. The ideal
	///     property for armor.
	/// </remarks>
	Malleable,
	...
	/// </summary>
	/// <remarks>
	///     Excellent Toughness. Indicates the material will deform under stress. Essential for wires, chains, and flexible
	///     components.
	/// </remarks>
	Ductile,
	...
	/// </summary>
	/// <remarks>
	///     Moderate Toughness, Low Hardness. Softer than brittle materials. Can be worked easily but won't hold an edge
	...
	/// </summary>
	/// <remarks>
	///     High Resilience. Doesn't hold a rigid edge, but is extremely resistant to permanent damage from bending forces.
	///     Perfect for things like
	///     springs or bow limbs.
	/// </remarks>
	Elastic
}
