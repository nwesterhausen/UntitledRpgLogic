...
{
	/// <summary>
	///     A reserved ULID for the GameSystem. This is used to identify the game system itself and should not be used for any
	///     other purpose.
	/// </summary>
	public static readonly Ulid GameSystem = Ulid.Parse("01K2MHERM20K401ENRX9JR472K", CultureInfo.InvariantCulture);

	/// <summary>
	///     A reserved ULID for a universal stat representing character / player level. This enables some canonical checks
