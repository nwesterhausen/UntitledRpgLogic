...
public enum FractureType
{
	...
	/// </summary>
	/// <remarks>
	///     Excellent Toughness. Doesn't hold a sharp edge as well as a hard material, but it will bend or deform instead of breaking. The ideal
	///     property for armor.
	/// </remarks>
	Malleable,
	...
	/// </summary>
	/// <remarks>
	///     High Resilience. Doesn't hold a rigid edge, but is extremely resistant to permanent damage from bending forces. Perfect for things like
