...
public record ItemDataConfig : ITomlConfig
{
	...
	/// </summary>
	public Quality ItemQuality { get; set; } = Quality.None;
	...
	/// </summary>
	public Guid CraftedBy { get; set; } = ReservedGuids.GameSystem;
	...
	/// </summary>
	public DimensionScale DimensionScale { get; set; } = DimensionScale.Cm;
	...
	/// </summary>
	public ShapeType ShapeType { get; set; } = ShapeType.RectangularPrism;
