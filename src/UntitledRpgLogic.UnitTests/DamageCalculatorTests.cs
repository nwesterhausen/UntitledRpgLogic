...
public class DamageCalculatorTests
{
	...
	public void CalculateMitigatedDamage_WithResistanceAndMitigation_ReducesCorrectly()
	{
		...
		var damage = this.calculator.CalculateMitigatedDamage(100, 0.25f, 10);
	...
	{
		var damage = this.calculator.CalculateMitigatedDamage(10, 0.50f, 20);
	...
	{
		Assert.Throws<ArgumentNullException>(() => this.calculator.CalculatePointDamage(null!, new Stat()));
	...
	{
		var finalDamage = this.calculator.CalculateMitigatedDamage(250, 1.0f, 0);
	...
	{
		var finalDamage = this.calculator.CalculateMitigatedDamage(-50, 0.2f, 5);
