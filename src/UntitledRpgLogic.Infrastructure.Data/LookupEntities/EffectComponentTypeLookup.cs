...
/// <summary>
/// Provides a reference table in the databse for the <see cref="EffectComponentType" /> enum.
/// </summary>
public class EffectComponentTypeLookup
{

	///<summary>The specific enum for this entry</summary>
	public EffectComponentType Id { get; set; }
